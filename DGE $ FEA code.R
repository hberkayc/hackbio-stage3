...
SelectData <- gbm.raw.data[,c('SelectBarcodes', 'SelectBarcodes1')]
dim(SelectData)
...
length(SelectBarcodes)


# Differential gene analysis
SelectResults <- TCGAanalyze_DEA(
  mat1 = filtData[, SelectBarcodes[1:10]],  # Selects the first 10 samples
  mat2 = filtData[, SelectBarcodes[11:20]], # Selects the next 10 samples
  Cond1type = "Tumor",
  Cond2type = "Normal",
  pipeline = "edgeR",
